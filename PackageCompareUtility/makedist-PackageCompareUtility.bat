@echo off
set TargetName=PackageCompareUtility
...
set out=S:\Sims3\Tools\sims3tools\builds\PackageCompareUtility\
...
pushd ..
7za a -r -t7z -mx9 -ms -xr!.?* -xr!*.suo -xr!zzOld -xr!bin -xr!obj -xr!Makefile -xr!*.Config "%out%%src%_%suffix%.7z" PackageCompareUtility
popd
